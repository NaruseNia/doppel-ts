...
| 2 | TASK-002: パーサー抽象レイヤー設計・実装 | TASK-001 | M | 🔲 Ready |
| 2 | TASK-007: Rust ネイティブアドオン基盤 | TASK-001 | M | 🔲 Ready |
| 2 | TASK-011: 設定ファイルローダー | TASK-001 | M | 🔲 Ready |
| 3 | TASK-003: React コンポーネント検出 | TASK-002 | L | ⏳ Blocked |
| 3 | TASK-008: 特徴ベクトル生成（Rust） | TASK-007 | L | ⏳ Blocked |
| 3 | TASK-004: Props 型抽出 | TASK-002, TASK-003 | L | ⏳ Blocked |
| 3 | TASK-005: JSX ツリー抽出・正規化 | TASK-002, TASK-003 | L | ⏳ Blocked |
