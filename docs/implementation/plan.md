...
| フェーズ | タスク | 依存 | 規模 |
|---------|--------|------|------|
| 1 | TASK-001: monorepo 基盤構築 | - | M |
| 2 | TASK-002: パーサー抽象レイヤー設計・実装 | TASK-001 | M |
| 2 | TASK-007: Rust ネイティブアドオン基盤 | TASK-001 | M |
| 2 | TASK-011: 設定ファイルローダー | TASK-001 | M |
| 3 | TASK-003: React コンポーネント検出 | TASK-002 | L |
| 3 | TASK-008: 特徴ベクトル生成（Rust） | TASK-007 | L |
| 3 | TASK-004: Props 型抽出 | TASK-002, TASK-003 | L |
| 3 | TASK-005: JSX ツリー抽出・正規化 | TASK-002, TASK-003 | L |
| 3 | TASK-009: 類似度計算エンジン（Rust） | TASK-008 | L |
| 4 | TASK-006: 構造データ正規化 | TASK-004, TASK-005 | M |
| 4 | TASK-010: 多段階閾値判定・重み付け | TASK-009 | S |
| 4 | TASK-012: CLI 実装 | TASK-011 | M |
| 4 | TASK-014: suppress 機能 | TASK-011, TASK-009 | S |
| 5 | TASK-013: 出力フォーマッター | TASK-009, TASK-012 | M |
| 5 | TASK-015: パイプライン統合・E2E テスト | TASK-006, TASK-009, TASK-012, TASK-013, TASK-014 | L |
| 5 | TASK-016: ベンチマーク・パフォーマンス最適化 | TASK-015 | M |
| 5 | TASK-017: npm 配布・CI 設定 | TASK-015 | M |
